...
public interface StorageInterface {
     ...
     * @param dbName
     * @return
     *     returns introsde.project.storage.soap.GetItemResponse.ListofPropertiesofItems
     */
    @WebMethod
    ...
    public introsde.project.storage.soap.GetItemResponse.ListofPropertiesofItems getItem(
        @WebParam(name = "dbName", targetNamespace = "")
        RecombeeDBType dbName,
        @WebParam(name = "itemName", targetNamespace = "")
        String itemName);
